...
export const prStatusCache = sqliteTable(
	'pr_status_cache',
	{
		...
		reviewStatus: text('review_status', {enum: ['clean', 'approved', 'changes_requested', 'commented', 'no_pr']}).notNull(),
		checkStatus: text('check_status', {enum: ['pending', 'running', 'passed', 'failed', 'none', 'unknown']}).notNull(),
		prUrl: text('pr_url'),
