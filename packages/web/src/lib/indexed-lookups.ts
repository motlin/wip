 ...
 */
export async function lookupIssueByNumber(repo: string, number: number): Promise<GitHubIssue | null> {
 ...
 */
export async function lookupProjectItemByNumber(repo: string, number: number): Promise<GitHubProjectItem | null> {
