...
const CATEGORY_ORDER: Category[] = ['skippable', 'snoozed', 'no_test', 'local_changes', 'ready_to_test', 'test_failed', 'ready_to_push', 'pushed_no_pr', 'checks_running', 'checks_failed', 'checks_passed', 'review_comments', 'changes_requested', 'approved'];
